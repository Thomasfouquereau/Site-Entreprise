...
const ProjetECommerce_container = styled.div`
    display: flex;
...
const ProjetECommerce_container__message = styled.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: center;
...
export default function ProjetECommerce() {
    return (
        <ProjetECommerce_container>
            <ProjetECommerce_container__info>
            ...
            <ProjetECommerce_container__message>
                <p>
                    <span>Désole</span>,
                    <br />
